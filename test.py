...
genai.configure(api_key="AIzaSyDBj1Ke9raKc03aHYpnou9ikGKT6lUPBn4") # Set your key as an environment variable
...
"""
    ...
    # Use clause-based summaries to generate final summary if needed
    final_summary_source = full_doc_summary
    if not allow_full_summary or "Failed to generate" in full_doc_summary:
